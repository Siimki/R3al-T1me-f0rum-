...
export function createPost() {
  ...
  function createButtonDiv(action, buttonText, buttonName, buttonValue) {
    ...
    buttonDiv.className =
      "bg-blue-300 hover:bg-blue-400 border rounded p-2 transition duration-500";
  ...
  flexDiv.appendChild(
    createButtonDiv("", "My liked posts", "myposts", "mylikedposts")
  );
  flexDiv.appendChild(
    createButtonDiv("", "Show all posts", "myposts", "normal")
  );

  // Create the "Log out" button
  flexDiv.appendChild(
    createButtonDiv("/logout", "Log out", "log-out", "Log out")
  );
  appDiv.className = "";
  ...
  postSubmissionArea.className =
    "flex flex-col p-8 bg-gray-200 mb-4 mx-16 rounded";
  ...
  postSubmitButton.className =
    "bg-blue-300 hover:bg-blue-400 border rounded m-2 px-2 transition duration-500";
